...
@Component({
  selector: 'app-employee-scanner',
  templateUrl: './employee-scanner.page.html',
  styleUrls: ['./employee-scanner.page.scss'],
...
export class EmployeeScannerPage implements OnInit {
