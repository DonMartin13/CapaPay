...
@Component({
  ...
  imports: [InstantSendComponent,IonModal, IonButtons, IonNote, IonTextarea, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonTitle, IonHeader, IonFabButton, IonFab, IonItem, IonListHeader, IonList, IonButton, IonApp, IonIcon, IonTabButton, IonLabel, IonFooter, IonContent, IonToolbar, IonTabs, IonTabBar, IonInput] 
